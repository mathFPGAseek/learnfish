...
for i = 1 : P
    ...
    [trainedSpectVisClassifierA, validationAccuracy] = trainSpectVisClassifierA(trainingData,KFolds);
    debug = 0;

    %% ----------------------------
    % Step #3: Avg & Var Results
    %% ----------------------------
    [avgSensorAccuracy,varSensorAccuracy,sensorAccuracy] = predictSpectVisClassifierA(tbl_vis,...
                                          randomRuns,...
                                          M,N,num_meas_vis,...
                                          dim_vis,...
...
for i = 1 : P
    ...
    %% ----------------------------
    %[trainedClassifier, validationAccuracy] = trainSpectFluorClassifierA(trainingData);
    [trainedSpectVisClassifierB, validationAccuracy] = trainSpectVisClassifierB(trainingData,KFolds);
    debug = 0;

    %% ----------------------------
    % Step #3: Avg & Var Results
    %% ----------------------------
    [avgSensorAccuracy,varSensorAccuracy,sensorAccuracy] = predictSpectVisClassifierB(tbl_vis,...
                                          randomRuns,...
                                          M,N,num_meas_vis,...
                                          dim_vis,...
