%% ------------------------------------------------------------------------
% filename: predictSpectRamanClassifierA.m
% rbd 9/29/19
% University of North Dakota 
% EE 999 ; Professor Tavakolian                      
%% ----------------------------
function [avgSensorAccuracy,...
          varSensorAccuracy] = predictSpectRamanClassifierA(tbl_raman,...
                                          randomRuns,...
                                          M,N,num_meas_raman,...
                                          dim_raman,...
...
for k = 1 : randomRuns 
    ...
    debug = 0;
    yfit = trainedSpectRamanClassifierA.predictFcn(DecisionFittingData);
    debug = 0;
