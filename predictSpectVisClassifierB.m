%% ------------------------------------------------------------------------
% filename: predictSpectSVisClassifierB.m
% rbd 9/29/19
% University of North Dakota 
% EE 999 ; Professor Tavakolian                       
%% ----------------------------
function [avgSensorAccuracy,...
          varSensorAccuracy] = predictSpectVisClassifierB(tbl_vis,...
                                          randomRuns,...
                                          M,N,num_meas_vis,...
                                          dim_vis,...
...
for k = 1 : randomRuns 
    ...
    debug = 0;
    yfit = trainedSpectVisClassifierB.predictFcn(DecisionFittingData);
    debug = 0;
