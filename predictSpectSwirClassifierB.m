%% ------------------------------------------------------------------------
% filename: predictSpectSwirClassifierB.m
% rbd 9/29/19
% University of North Dakota 
% EE 999 ; Professor Tavakolian                      
%% ----------------------------
function [avgSensorAccuracy,...
          varSensorAccuracy] = predictSpectSwirClassifierB(tbl_SWIR,...
                                          randomRuns,...
                                          M,N,num_meas_swir,...
                                          dim_swir,...
...
for k = 1 : randomRuns 
    ...
    debug = 0;
    yfit = trainedSpectSwirClassifierB.predictFcn(DecisionFittingData);
    debug = 0;
