...
for i = 1 : P
    ...
    [trainedSpectSwirClassifierA, validationAccuracy] = trainSpectSwirClassifierA(trainingData,KFolds);
    debug = 0;

    %% ----------------------------
    % Step #3: Avg & Var Results
    %% ----------------------------
    [avgSensorAccuracy,varSensorAccuracy,sensorAccuracy] = predictSpectSwirClassifierA(tbl_SWIR,...
                                          randomRuns,...
                                          M,N,num_meas_swir,...
                                          dim_swir,...
...
for i = 1 : P
    ...
    %% ----------------------------
    %[trainedClassifier, validationAccuracy] = trainSpectFluorClassifierA(trainingData);
    [trainedSpectSwirClassifierB, validationAccuracy] = trainSpectSwirClassifierB(trainingData,KFolds);
    debug = 0;

    %% ----------------------------
    % Step #3: Avg & Var Results
    %% ----------------------------
    [avgSensorAccuracy,varSensorAccuracy,sensorAccuracy] = predictSpectSwirClassifierB(tbl_SWIR,...
                                          randomRuns,...
                                          M,N,num_meas_swir,...
                                          dim_swir,...
